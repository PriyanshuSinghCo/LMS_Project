    ...
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
        {dummyTestimonial.map((testimonial, index) => (
          <div
            key={index}
            className="max-w-sm w-full mx-auto text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden"
          >
            ...
            <a href="#" className="text-red-900 px-5">Read more→</a>
          </div>
        ))}
      </div>
    </div>
